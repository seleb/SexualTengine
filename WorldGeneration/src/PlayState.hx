...
class PlayState extends Sprite{
	...
	public function new() {
		...
		player.animation.addAnimationState("main", "down", [0,1,2,3,4,5,6,7], 50, 51, 70);
		player.animation.addAnimationState("main", "left", [8,10,11,9,12,13,14,15], 50, 51, 70);
		player.animation.addAnimationState("main", "right", [16,18,19,17,20,21,22,23], 50, 51, 70);
		player.animation.addAnimationState("main", "up", [24,25,26,27,28,29,30,31], 50, 51, 70);
